...
fun HtmlElements.pfEmptyState(iconClass: String, title: String, content: Div.() -> Unit = {}): EmptyState =
    register(EmptyState(iconClass, title, content), { })
...
class EmptyState(iconClass: String, title: String, content: Div.() -> Unit) :
...
class EmptyStateBody : Tag<HTMLDivElement>("div", baseClass = "empty-state".component("body"))
